...
namespace IOGKFExams.Client
{
    ...
    {
        private const string UserStateKey = "IOGKFExams.Server.ApplicationUser";
        ...
        public SecurityService(NavigationManager navigationManager, IHttpClientFactory factory, PersistentComponentState persistentComponentState)
        {
            this.baseUri = new Uri($"{navigationManager.BaseUri}odata/Identity/");
            this.httpClient = factory.CreateClient("IOGKFExams.Server");
