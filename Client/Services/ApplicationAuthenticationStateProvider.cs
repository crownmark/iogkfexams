...
namespace IOGKFExams.Client
{
    ...
    {
        private const string AuthenticationStateKey = "IOGKFExams.Server.AuthenticationState";
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            try
            {
                ...
                {
                    identity = new ClaimsIdentity(state.Claims.Select(c => new Claim(c.Type, c.Value)), "IOGKFExams.Server");
                }
            }
