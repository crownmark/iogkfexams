...
namespace IOGKFExams.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<IOGKFExams.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<IOGKFExams.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(IOGKFExams.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(IOGKFExams.Server.Models.ApplicationUser user)
        {
            try
            {
