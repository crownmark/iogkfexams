...
{
    public partial class AddNotificationTemplate
    {
        [Inject]
        ...
        {
            notificationTemplate = new IOGKFExams.Server.Models.IOGKFExamsDb.NotificationTemplate();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await IOGKFExamsDbService.CreateNotificationTemplate(notificationTemplate);
