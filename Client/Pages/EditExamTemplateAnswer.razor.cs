...
{
    public partial class EditExamTemplateAnswer
    {
        [Inject]
        ...
        {
            examTemplateAnswer = await IOGKFExamsDbService.GetExamTemplateAnswerByExamTemplateAnswerId(examTemplateAnswerId:ExamTemplateAnswerId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await IOGKFExamsDbService.UpdateExamTemplateAnswer(examTemplateAnswerId:ExamTemplateAnswerId, examTemplateAnswer);
